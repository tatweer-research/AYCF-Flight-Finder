...
class TestFlightFinderService(unittest.TestCase):
    ...
    def test_find_possible_one_stop_flights_direct(self):
        ...
        service = FlightFinderService()

        service.find_possible_one_stop_flights(max_stops=data_manager.config.flight_data.max_stops)
    ...
    def test_find_possible_roundtrip_flights(self):
        ...
        service.find_possible_roundtrip_flights_from_departure_airports()
        generated = data_manager.get_possible_flights()
    ...
    def test_find_available_oneway_flights_direct(self):
        ...
        generated = service.find_available_oneway_flights()
    ...
    def test_find_available_roundtrip_flights(self):
        ...
        generated = service.find_available_roundtrip_flights()
